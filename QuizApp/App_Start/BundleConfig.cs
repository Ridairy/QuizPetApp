...
namespace QuizApp
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/admin-angular-controllers").Include(
                      "~/Scripts/AngularControllers/QuizAppInit.js",
                      "~/Scripts/AngularControllers/AdminQuizList.js",
                      "~/Scripts/AngularControllers/AdminQuizResults.js",
                      "~/Scripts/AngularControllers/AdminQuizUrl.js"
                      ));
            bundles.Add(new ScriptBundle("~/bundles/quiz-angular-controllers").Include(
                      "~/Scripts/AngularControllers/QuizPass.js"
                      ));
        }
    }
}
